...
return {
	...
	_: {
		client: {"start":"_app/immutable/entry/start.f9vH--S8.js","app":"_app/immutable/entry/app.BuHQTAhW.js","imports":["_app/immutable/entry/start.f9vH--S8.js","_app/immutable/chunks/entry.wbOk-ied.js","_app/immutable/chunks/scheduler.PqqiGW0i.js","_app/immutable/chunks/index.-tsgyc6O.js","_app/immutable/entry/app.BuHQTAhW.js","_app/immutable/chunks/scheduler.PqqiGW0i.js","_app/immutable/chunks/index.McjGVyOV.js"],"stylesheets":[],"fonts":[],"uses_env_dynamic_public":false},
		nodes: [
			__memo(() => import('./chunks/0-F_WF1Jxa.js')),
			__memo(() => import('./chunks/1-XJ_zbTfr.js')),
			__memo(() => import('./chunks/2-qulPL_uK.js')),
			__memo(() => import('./chunks/3-_bIGo0DC.js')),
			__memo(() => import('./chunks/4--7_dzDM1.js')),
			__memo(() => import('./chunks/5-BtDC03B-.js')),
			__memo(() => import('./chunks/6-pXVsS-dK.js')),
			__memo(() => import('./chunks/7-FskFwTHe.js')),
			__memo(() => import('./chunks/8-a3xou42L.js')),
			__memo(() => import('./chunks/9-AHYPJKR1.js')),
			__memo(() => import('./chunks/10-5CcuavBB.js')),
			__memo(() => import('./chunks/11-5bIRqrri.js')),
			__memo(() => import('./chunks/12-7hjnWFk8.js')),
			__memo(() => import('./chunks/13-WOEDsgq2.js')),
			__memo(() => import('./chunks/14-hE7aXS9q.js')),
			__memo(() => import('./chunks/15-6eM5huhO.js')),
			__memo(() => import('./chunks/16-qccnsDeP.js')),
			__memo(() => import('./chunks/17-amPln4_V.js')),
			__memo(() => import('./chunks/18-3XiMPakk.js')),
			__memo(() => import('./chunks/19-qfP5pYLN.js')),
			__memo(() => import('./chunks/20-96XF9jV5.js')),
			__memo(() => import('./chunks/21-TSltmm8b.js')),
			__memo(() => import('./chunks/22-dXNKdIbn.js')),
			__memo(() => import('./chunks/23-crOVyNki.js')),
			__memo(() => import('./chunks/24-PAtKQoH1.js')),
			__memo(() => import('./chunks/25-UIVw7-Xd.js')),
			__memo(() => import('./chunks/26-cAYCcnD5.js')),
			__memo(() => import('./chunks/27-xnt3ngEL.js')),
			__memo(() => import('./chunks/28-MAcx6A1K.js')),
			__memo(() => import('./chunks/29-vbZwRZxg.js')),
			__memo(() => import('./chunks/30-iT8CzOB4.js')),
			__memo(() => import('./chunks/31-9rSEnpLp.js')),
			__memo(() => import('./chunks/32-sDQERJFD.js')),
			__memo(() => import('./chunks/33-DzowPgOa.js')),
			__memo(() => import('./chunks/34-SMFu-h06.js')),
			__memo(() => import('./chunks/35-8xh7v9C8.js')),
			__memo(() => import('./chunks/36-crbmutei.js')),
			__memo(() => import('./chunks/37-yr32Ckoj.js'))
		],
		routes: [
			{
				id: "/",
