...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/1-MC2jtgfr.js')),
			...
			__memo(() => import('./chunks/9-G-y05zP9.js')),
			__memo(() => import('./chunks/10-ocwVqDaZ.js')),
			__memo(() => import('./chunks/11-HwmeA555.js')),
			__memo(() => import('./chunks/12-DOQX0PKO.js')),
			__memo(() => import('./chunks/13-aZZXcsMj.js')),
			__memo(() => import('./chunks/14-tvp_v3vy.js')),
			__memo(() => import('./chunks/15-2AQ0Fa9i.js')),
			__memo(() => import('./chunks/16-PUJPkBr0.js')),
			__memo(() => import('./chunks/17-QP3vWB2Y.js')),
			__memo(() => import('./chunks/18-OKfFV4pT.js')),
			__memo(() => import('./chunks/19-T6nQn3kV.js')),
			__memo(() => import('./chunks/20-Kefq5_nM.js')),
			__memo(() => import('./chunks/21-qxTmus9K.js')),
			__memo(() => import('./chunks/22-wMVI1sBe.js')),
			__memo(() => import('./chunks/23-QfE4aYng.js')),
			__memo(() => import('./chunks/24-3bsAoy9P.js')),
			__memo(() => import('./chunks/25-174iltd7.js')),
			__memo(() => import('./chunks/26-MYPA4RXs.js')),
			__memo(() => import('./chunks/27-cSeXWS6e.js')),
			__memo(() => import('./chunks/28-xuOC3rHX.js')),
			__memo(() => import('./chunks/29-zQv7mwT1.js')),
			__memo(() => import('./chunks/30-Jt_xoG59.js')),
			__memo(() => import('./chunks/31-W5VrOTm4.js')),
			__memo(() => import('./chunks/32-jWbuUxAx.js')),
			__memo(() => import('./chunks/33-awLOyx9t.js')),
			__memo(() => import('./chunks/34-PUMufrEP.js')),
			__memo(() => import('./chunks/35-XT4HZzjw.js')),
			__memo(() => import('./chunks/36-eqf0WDhh.js')),
			__memo(() => import('./chunks/37-5UFpfR9D.js')),
			__memo(() => import('./chunks/38-NY0a3fHp.js'))
		],
		routes: [
			{
				id: "/",
